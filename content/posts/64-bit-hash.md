...
<small>2. The truncation throuhput code [is here](https://github.com/avinassh/xxhash_benchmark) and hashevals code [is here](https://github.com/avinassh/HashEvals/tree/twox-hash).</small>
